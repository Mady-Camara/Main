...
public class db_connection {
 ...
 public Connection connexionDatabase() {
  ...
  connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/Inscription", "root", "Iloveinformatique");
        } catch (Exception e) 
...
//Overload fungsi eksekusi query delete dengan where
    ...
    public ResultSet querySelect1(String t, String patient, String string) {
        connexionDatabase();
        SQL = "SELECT "+t+" FROM " + patient + " WHERE " + string;
       return this.exécutionQuery(SQL);
